...
D3FEND™ - A knowledge graph of cybersecurity countermeasures: LinkML Schema

## Documentation Website

[https://lmodel.github.io/d3fend](https://lmodel.github.io/d3fend)
...
* [src/](src/) - source files (edit these)
  * [d3fend](src/d3fend)
    * [schema/](src/d3fend/schema) -- LinkML schema
      (edit this)
    * [datamodel/](src/d3fend/datamodel) -- generated
      Python datamodel
